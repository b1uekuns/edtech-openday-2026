...
function applyNavState() {
  ...
  navLinks.forEach((link) => {
    ...
    if (isHomePage) {
      ...
      const activitiesPages = ["seminars.html", "boardgame.html", "gpbl.html", "openday.html", "taphuan.html", "hoatdongngoaikhoa.html", "viettel.html", "fpt.html", "ikame.html", "chapcanh.html"];
